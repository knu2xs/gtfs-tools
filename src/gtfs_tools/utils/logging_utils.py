...
def configure_logging(
    level: Optional[Union[str, int]] = "INFO", logfile_path: Union[Path, str] = None
) -> logging.Logger:
    """
...
def format_pandas_for_logging(
    ...
    """
    Helper function facilitating outputting a :class:`Pandas DataFrame<pandas.DataFrame>` into a logfile. This function
    only formats the data frame into text for output. It should be used in conjunction with a logging method.
